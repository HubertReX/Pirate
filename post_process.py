...
def main(arraytype=None):
    ...
    imagename = os.path.join('/Users/hubertnafalski/Library/Python/3.9/lib/python/site-packages/pygame/examples/data/arraydemo.bmp')
    ...
    hue = make_edit(rgbarray, 0, 50, 0)
    surfdemo_show(hue, 'hue')
