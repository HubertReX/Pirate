...
function prerun(VM) {
    ...
    for (const arg of VM.PyConfig.argv) {
        VM.arguments.push(arg)
    }
...
== DEBUG 222 user=${debug_user} dev=${debug_dev} m=${debug_mobile} is_mobile(${nuadm}) ==
...
console.log("pythons found at", url , elems)
            ...
            vm.sys_argv.push("mobile="+ mobile_platform)
